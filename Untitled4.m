...
load("DataAt200Hz14400Baud-up-3","datapoints");
load("DataAt200Hz14400Baud-up-3","feat");
...
% Feature vector
% features = [length(yUP), f1, f2, f3, f4, f5, f6, hzP10/totalPower, hzP20/totalPower, hzP30/totalPower, hzP50/totalPower, hzP60/totalPower, hzP100/totalPower];
...
for j = 1:length(yUP)
    ...
    if (counting==true)
        ...
        if (((average > -200/stdV) && (average < 200/stdV))  && full)
            or = or * -1;
            counting = false; 
            lastIndex = j;
%           plotting = true;
            ...
            featuresTest = [featuresTest ;lastIndex - firstIndex ,f1, f2, f3, f4, f5, f6, hzP10/totalPower, hzP20/totalPower, hzP30/totalPower, hzP50/totalPower, hzP60/totalPower, hzP100/totalPower];
            ClassTest = [ClassTest; "down"];
...
%  downTable.Properties.VariableNames(1:13) = ["length in points","Enhanced Mean Absolute Value",	"Average Amplitude Change",	"WaveFormLength", "Maximum Fractal Length", "Root Mean Square",	"Zeros Crossing", "PowerHz[1,10]","PowerHz[10,20]",	"PowerHz[20,30]", "PowerHz[30,50]",	"PowerHz[50,60]",	"PowerHz[60,99]"];
